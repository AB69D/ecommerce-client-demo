        ...
        return (
            <div className="w-full py-8 px-4 overflow-hidden">
                <div className="flex items-center justify-between mb-6 max-w-7xl mx-auto">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-gray-50 tracking-tight">New Arrivals</h2>
                                ...
                                >
                                    ...
                                    >
                                        <div className="relative aspect-square bg-gray-100 dark:bg-gray-800 overflow-hidden">
                                            ...
                                            {/* Desktop-only hover bonus — Quick View still works by tapping
                                                the card on touch devices, so this doesn't gate any functionality. */}
                                            ...
                                            <QuickAddButton product={product} className="absolute bottom-2 right-2 w-8 h-8 sm:w-9 sm:h-9" />
                                        </div>
                        ...
                        {Array.from({ length: totalPages }, (_, i) => (
                            <button
                                ...
                                className={`rounded-full transition-all duration-300 focus:outline-none ${currentPage === i
                                        ...
                                        : "w-2 h-2 sm:w-3 sm:h-3 bg-gray-300 dark:bg-gray-700 hover:bg-gray-400 dark:hover:bg-gray-600"
                                    }`}
